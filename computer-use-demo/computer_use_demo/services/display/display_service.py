"""Display Service - Dynamic Virtual Display and VNC Allocation.
...
class DisplayService:
    ...
    def __init__(self):
        ...
        self._next_display = settings.BASE_DISPLAY_NUM
    ...
    async def _start_xvfb(self, allocation: DisplayAllocation) -> None:
        ...
        res = f"{settings.WIDTH}x{settings.HEIGHT}x24"
